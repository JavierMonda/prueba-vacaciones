...
<head>
    ...
    <title>Servicio Técnico - Aplicación de Oasis Park Fuerteventura</title>
    ...
    <div class="row text-center">
        <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
                ...
                <div class="caption">
                    ...
                    <p>Ver y dar de alta partes de trabajo</p>
                    <p>
                        <a href="pages/partes.php" class="btn btn-primary" role="button">Administrar</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
                ...
                <div class="caption">
                    ...
                    <p>Ver y dar de alta tipos de trabajo</p>
                    <p>
        ...
        <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
                ...
                <div class="caption">
                    <h3>Zonas</h3>
                    <p>Ver y dar de alta zonas donde se realizarán los trabajos</p>
                    <p>
                        <a href="#" class="btn btn-primary" role="button">Consultar</a>
                    </p>
                </div>
